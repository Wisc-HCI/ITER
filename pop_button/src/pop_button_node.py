...
'''
Pop Button Node
Author: Andrew Brock (Original), Curt Henrichs (ROS Node)
Date: 6-27-19

Provides a ROS interface for the pop button which uses a local network connection
instead of IFTTT. The local connection option was choosen soley due to latency.
...
rospy.init_node("pop_button_node")
