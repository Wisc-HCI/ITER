...
if __name__ == "__main__":
    ...
    for q in config['queues']:
        if q['name'] == 'queue_small_1':
            QUEUES[q['name']] = Queue(q['position'],'HORIZONTAL_RIGHT',6,BLOCK_SMALL,SPACING,mode=q['mode'],offset_z=False,name_unique='_s1')
        elif q['name'] == 'queue_small_2':
            QUEUES[q['name']] = Queue(q['position'],'HORIZONTAL_RIGHT',6,BLOCK_SMALL,SPACING,mode=q['mode'],offset_z=False,name_unique='_s2')
        elif q['name'] == 'queue_large_1':
            QUEUES[q['name']] = Queue(q['position'],'HORIZONTAL_RIGHT',6,BLOCK_LARGE,SPACING,mode=q['mode'],offset_z=False,name_unique='_l1')
