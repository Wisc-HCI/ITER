...
class AR2DDraw:
    ...
    def __init__(self):
        ...
        self.ar_sub = rospy.Subscriber("cam_pose_marker", AlvarMarkers, self._ar_cb, queue_size=5)
        self._markers = []
    ...
    def _image_cb(self, imageMsg):
        ...
        for m in self._markers:
            ...
            rx,ry,rz = tf.transformations.euler_from_quaternion((orientation.x,orientation.y,orientation.z,orientation.w))

            rect = ((position.x,position.y),(10,10),rz)
