...
class RelaxedIK_vars(Vars):
    def __init__(self, name,
                 ...
                 objectives=(Position_MultiEE_Obj(), Orientation_MultiEE_Obj(), Min_Jt_Vel_Obj(),Min_Jt_Accel_Obj(),Min_Jt_Jerk_Obj(), Joint_Limit_Obj(), Elbow_Up_UR5_Obj(), Collision_Avoidance_nn()),
                 ...
                 weight_priors=(50.0,49.0,3.0,1.0,2.0,10.0,0.2,2.0),
                 constraints=(),
                 bounds=(),
                 collision_file='',
                 collision_nn_file='',
