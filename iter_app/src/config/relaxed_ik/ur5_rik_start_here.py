...
# Note: this is a copy of the 'start_here.py' relaxed_ik setup file used for ITER
# Specifically this file is developed for the UR5, to make use of this configuration
# simply rename the file to 'start_here.py' and copy into your relaxed_ik src
# directory.
